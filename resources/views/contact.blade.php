    ...
    <body>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Masih bingung soal bermain slot?  Tidak usah sungkan untuk menanyakannya dengan mengisi form yang ada dibawah ini, team kami akan menjawabnya segera.</p>
                        <div class="my-5">
                            <!-- * * * * * * * * * * * * * * *-->
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="/contact" method="POST">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="phone" type="tel" name="phone_number" placeholder="Enter your phone number..." data-sb-validations="required" />
                                ...
                                <br />
                                <!-- Submit Button-->
                                <button class="btn btn-primary text-uppercase" type="submit">Kirim</button>
                            </form>
                        </div>
                    </div>
                </div>
