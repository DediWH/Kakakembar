                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    @foreach ($posts as $post)
                        ...
                        <div class="post-preview">
                            ...
                            <p class="post-meta">
                                Posted by
                                <a href="https://www.instagram.com/prawijayaa_/">prawijayaa_</a>, {{ $post->created_at->diffForHumans() }}
                            </p>
                        </div>
                        <!-- Divider-->
                        <hr class="my-4" />
                    @endforeach
                    <!-- Pager-->
                    <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="/older_post">Older Posts →</a></div>
                </div>
            </div>
        </div>
